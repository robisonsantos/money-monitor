      ...
      <div class="flex justify-between h-16">
        <div class="flex items-center">
          ...
          <nav class="hidden md:ml-6 md:flex md:space-x-8">
            <a
              href="/dashboard"
              class="flex items-center space-x-2 text-blue-600 hover:text-blue-700 px-3 py-2 rounded-md text-sm font-medium transition-colors group"
            >
            ...
            <a
              href="/dashboard/add"
              class="flex items-center space-x-2 text-gray-500 hover:text-blue-600 px-3 py-2 rounded-md text-sm font-medium transition-colors group"
            >
